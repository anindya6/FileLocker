 ...
 * services.
 */
public abstract class GoogleDriveTools extends Activity {
    ...
    protected Task<DriveId> pickFile(String name) {
        OpenFileActivityOptions openOptions =
                new OpenFileActivityOptions.Builder()
                        .setSelectionFilter(Filters.eq(SearchableField.TITLE, name))
                        .setActivityTitle("Select File: ")
                        .build();
        return pickItem(openOptions);
    }
